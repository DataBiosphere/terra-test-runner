...
Publish the Test Runner library after making changes. The script assumes a valid
Vault token is either passed as the first argument to the script, or is stored
at `$HOME/.vault-token`.
